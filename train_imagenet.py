...
def get_args_parser():
    ...
    parser.add_argument('--iidp', default='/mnt/data/melon/imagenet/imagenet12', help='path for imagenet1k')
    parser.add_argument('--iodp', default='/mnt/data/IMAGENET', help='path for imagenet10k')
